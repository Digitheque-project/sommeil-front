...
export default function ConsultationTraitementPage() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const patient = searchParams.get("patient") ?? fakeConsultation.patientName;
  const consultationId = searchParams.get("id") ?? "29481";
