...
export default function ConsultationTraitementClient({
  ...
  const updateMedication = (id: number, field: keyof Omit<Medication, "id">, value: string | number) =>
